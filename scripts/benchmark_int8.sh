...
echo "--------- Benchmarking INT8 quantization of everything on COCO (make sure that all flags in ops.py are False) ---------"
...
echo "--------- Benchmarking INT8 quantization of everything on LVIS (make sure that all flags in ops.py are False) ---------"
